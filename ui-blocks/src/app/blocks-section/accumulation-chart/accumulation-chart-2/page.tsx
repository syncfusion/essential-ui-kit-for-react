...
export default function AccumulationChart2() {
    /* SB Code - Start */
            ...
            case 'tailwind':
                return (
                    <section className="bg-white dark:bg-gray-950">
                        <div key={'accumulationchart-2-tw'} className="h-screen flex justify-center p-4 sm:p-6">
                                ...
                                <div className="mt-2">
                                    <AccumulationChartComponent ref={chartRef} width="100%" height={isMobileview ? '360px' : '240px'} legendSettings={legendSettings} enableBorderOnMouseMove={false} load={(args) => chartLoad(args, 'Tailwind3', 'Tailwind3Dark')}>
                                        ...
                                        <AccumulationSeriesCollectionDirective>
                                            <AccumulationSeriesDirective dataSource={chartData} xName="x" yName="y" innerRadius="55%" radius="100%" dataLabel={dataLabel} palettes={["#5A61F6", "#91BD34", "#FFB900", "#DE4383", "#01A8B5"]} legendShape="Circle" border={getBorder('#000000')} borderRadius={6}></AccumulationSeriesDirective>
                                        </AccumulationSeriesCollectionDirective>
            ...
            case 'bootstrap5':
                return (
                    <section className="bg-body">
                        <div key={'accumulationchart-2-bs'} className="vh-100 d-flex justify-content-center p-3 p-sm-4">
                            <div className="w-100" style={{ maxWidth: '530px' }}>
                                ...
                                <div className="mt-4 mb-2 mx-auto d-none d-sm-block" style={{ width: 'fit-content' }}>
                                    <div className="e-btn-group">
                                        <input type="radio" id="week" name="align" value="Week" defaultChecked aria-label="week" role="button" />
                                        <label className="e-btn" htmlFor="week">Week</label>
                                        <input type="radio" id="month" name="align" value="Month" aria-label="month" role="button" />
                                ...
                                <div className="mt-2">
                                    <AccumulationChartComponent ref={chartRef} width="100%" height={isMobileview ? '360px' : '240px'} legendSettings={legendSettings} enableBorderOnMouseMove={false} load={(args) => chartLoad(args, 'Bootstrap5', 'Bootstrap5Dark')}>
                                        <Inject services={[AccumulationLegend, AccumulationDataLabel]} />
                                        <AccumulationSeriesCollectionDirective>
                                            <AccumulationSeriesDirective dataSource={chartData} xName="x" yName="y" innerRadius="55%" radius="100%" dataLabel={dataLabel} palettes={["#006EEF", "#0EAB44", "#FF9900", "#EF00AC", "#00EFA7"]} legendShape="Circle" border={getBorder('#212529')} borderRadius={6}></AccumulationSeriesDirective>
                                        </AccumulationSeriesCollectionDirective>
                                    </AccumulationChartComponent>
                                </div>
                            </div>
