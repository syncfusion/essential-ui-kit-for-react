                    ...
                    <section className="bg-gray-50 dark:bg-gray-950">
                        <div className="py-20">
                            ...
                            <div className="flex justify-center px-4">
                                <div className="rounded-3xl overflow-hidden md:mx-6 bg-white dark:bg-gray-900 shadow-none border border-gray-200 dark:border-gray-600 hover:border-primary-600 dark:hover:border-primary-400">
