...
export default function PricingCard4() {
    /* SB Code - Start */
                        ...
                        <div className="container px-3 py-5">
                            ...
                            <div className="row justify-content-center">
                                <div className="col-xl-4 col-lg-5 col-md-6 col-sm-12">
                                    <div className="e-card e-bigger lh-base px-2 py-4 my-4 my-md-0 rounded-4">
                                        <div className="e-card-content my-2">
                                            ...
                                            <p className="m-0 text-light-emphasis fs-6">A great solution for beginners</p>
                                            <div className="my-3">
                                ...
                                <div className="col-xl-4 col-lg-5 col-md-6 col-sm-12 pt-4 pt-sm-0">
                                    <div className="e-card e-bigger lh-base px-2 py-4 rounded-4">
                                        <div className="e-card-content my-2">
                                            <div className="d-flex justify-content-between">
                                                <span className="e-avatar-xlarge e-avatar e-icons e-group-icon e-avatar-circle mb-3 text-primary-emphasis bg-body-tertiary"></span>
                                                <span className="e-badge e-badge-pill bg-warning-subtle text-warning-emphasis e-bigger">
                                                    Most popular
                                                </span>
                                            </div>
                                            <h5 className="fs-4 fw-bold mb-1 text-body">Premium</h5>
                                            <p className="m-0 text-light-emphasis fs-6">All you need to create your website</p>
                                            <div className="my-3">
                                                <div className="d-flex align-items-center gap-2">
                                            ...
                                            <p className="mt-1 mb-0 text-light-emphasis fs-6">
                                                Create one end product for a client, transfer that end product to your client, charge them for your services.
                                            </p>
                                        </div>
                                        <div className="e-card-actions e-bigger">
