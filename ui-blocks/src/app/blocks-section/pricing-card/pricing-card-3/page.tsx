    ...
    const handleMessageEvent = (event: MessageEvent) => {
        if (event.origin === window.location.origin) {
            try {
                ...
                if (blockData.name === 'pricing-card-3' && blockData.theme) {
                    ...
                    <section className="bg-gray-50 dark:bg-gray-950">
                        <div className="max-w-screen-xl mx-auto py-20">
                            ...
                            <div className="flex justify-center">
                                <div className="grid sm:grid-cols-2 gap-6 w-full px-4 md:px-6 lg:w-9/12 xl:w-7/12 max-w-screen-2xl box-border">
                        ...
                        <div className="container px-3 py-5">
                            ...
                            <div className="row justify-content-center">
                                <div className="col-xl-4 col-lg-5 col-md-6 col-sm-12">
                                    <div className="e-card e-bigger px-2 lh-base rounded-4 mb-4 mb-md-0 py-4">
