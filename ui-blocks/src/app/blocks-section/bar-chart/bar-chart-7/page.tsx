...
import { Inject, ChartComponent, ColumnSeries, RangeColorSettingDirective, RangeColorSettingsDirective, SeriesCollectionDirective, SeriesDirective, DataLabel, Legend, Category } from "@syncfusion/ej2-react-charts";
                            ...
                            <div className="w-full" style={{ maxWidth: '930px' }}>
                                <div className="flex flex-col sm:flex-row justify-between sm:items-center gap-2">
                                    ...
                                    <div className="flex gap-1 items-center">
                                        ...
                                        <ButtonComponent cssClass="e-outline hidden sm:block ml-3" content="View Report" type="button"></ButtonComponent>
                                    </div>
                                </div>
                                <div className="mt-5">
                                    <ChartComponent ref={chartRef} chartArea={{ border: { width: 0 } }} width="100%" legendSettings={{ visible: true, mode: 'Range' }} primaryXAxis={primaryXAxis} primaryYAxis={primaryYAxis} load={(args) => chartLoad(args, 'Tailwind3', 'Tailwind3Dark')}>
                                        ...
                                        <SeriesCollectionDirective>
                                            <SeriesDirective dataSource={chartData} type="Column" xName="xAxis" yName="yAxis" name="season chart" cornerRadius={{ topLeft: 10, topRight: 10 }} legendShape="Rectangle" marker={marker} columnWidth={columnWidth}></SeriesDirective>
                                        </SeriesCollectionDirective>
                            ...
                            <div className="w-100" style={{ maxWidth: '930px' }}>
                                <div className="d-flex flex-column flex-sm-row justify-content-between align-items-sm-center gap-2">
                                    ...
                                    <div className="d-flex gap-2 align-items-center mt-2 mt-sm-0">
                                        ...
                                        <ButtonComponent cssClass="e-outline d-none d-sm-inline-block" content="View Report" type="button"></ButtonComponent>
                                    </div>
                                </div>
                                <div className="mt-4">
                                    <ChartComponent ref={chartRef} chartArea={{ border: { width: 0 } }} width="100%" legendSettings={{ visible: true, mode: 'Range', padding: 12 }} primaryXAxis={primaryXAxis} primaryYAxis={primaryYAxis} load={(args) => chartLoad(args, 'Bootstrap5', 'Bootstrap5Dark')}>
                                        <Inject services={[ColumnSeries, Category, DataLabel, Legend]} />
                                        <SeriesCollectionDirective>
                                            <SeriesDirective dataSource={chartData} type="Column" xName="xAxis" yName="yAxis" name="season chart" cornerRadius={{ topLeft: 10, topRight: 10 }} legendShape="Rectangle" marker={marker} columnWidth={columnWidth}></SeriesDirective>
                                        </SeriesCollectionDirective>
