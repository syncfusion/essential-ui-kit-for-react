            ...
            case 'tailwind':
                return (
                    <section className="bg-white dark:bg-gray-950">
                        <div key={"distributionchart-3-tw"} className="h-screen flex justify-center p-4 sm:p-6">
            ...
            case 'bootstrap5':
                return (
                    <section className="bg-body">
                        <div key={"distributionchart-3-bs"} className="vh-100 d-flex justify-content-center p-3 p-sm-4">
