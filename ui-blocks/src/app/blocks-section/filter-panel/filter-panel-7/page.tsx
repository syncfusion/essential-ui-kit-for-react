                ...
                return (
                    <section className="bg-white dark:bg-gray-900">
                        <div id={styles["filter-7"]} style={{ height: "960px", width: width, float: "right" }}>
                            <SidebarComponent key={"filter-7-tw"} ref={sidebarRef} className="flex flex-col bg-white dark:bg-gray-800" position="Right" type="Push" width={width} isOpen={true} closeOnDocumentClick={false} showBackdrop={true} style={{ display: "block" }}>
                                <div>
                                    <div className="flex justify-between items-center p-4 border-b border-gray-200 dark:border-gray-600">
                                        ...
                                        <ButtonComponent className="e-flat text-base" iconCss="e-icons e-close" type="button" onClick={() => sidebarRef.current?.toggle()}></ButtonComponent>
                                    </div>
                                    ...
                                    <div className="p-4">
                                        ...
                                        <div className="space-x-3 flex items-center mb-2">
                                            <RatingComponent cssClass="e-small" value={4} precision="Exact"></RatingComponent>
            ...
            case 'bootstrap5':
                return (
                    <section className="bg-body">
                        <div id={styles["filter-7"]} style={{ height: "960px", width: width, float: "right" }}>
                            <SidebarComponent key={"filter-7-bs"} ref={sidebarRef} className="d-flex flex-column bg-body" position="Right" type="Push" width={width} isOpen={true} closeOnDocumentClick={false} showBackdrop={true} style={{ display: "block" }}>
                                <div>
                                    <div className="d-flex justify-content-between align-items-center p-3 border-bottom">
                                        ...
                                        <ButtonComponent cssClass="e-flat fs-6" iconCss="e-icons e-close" type="button" onClick={() => sidebarRef.current?.toggle()}></ButtonComponent>
                                    </div>
