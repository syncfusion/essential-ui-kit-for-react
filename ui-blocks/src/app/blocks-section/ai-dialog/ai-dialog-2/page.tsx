                ...
                return (
                    <section>
                        <div id="dialog-container" className="relative" style={{ minHeight: "580px" }}>
                            <DialogComponent id={styles["dialog"]} ref={dialog} className="rounded-none sm:rounded-lg overflow-hidden" target="#dialog-container" isModal={true} width="400px" beforeOpen={(event) => (event.maxHeight = '100%')} open={(event) => (event.preventFocus = true)}>
                                <div className="flex flex-col gap-6 px-4 py-6 sm:px-6 h-full">
                                    ...
                                    <div className="flex gap-3">
                                        <ButtonComponent cssClass="w-1/2" type="button">Cancel</ButtonComponent>
                                        <ButtonComponent cssClass="e-primary w-1/2" type="submit">Submit</ButtonComponent>
                                    </div>
                                </div>
                            </DialogComponent>
                        </div>
                        ...
                        <div className="top-0 left-0 absolute w-full flex">
                            <ButtonComponent className="my-5 mx-auto" onClick={() => dialog.current?.show()} type="button">Feedback for Improvement</ButtonComponent>
                        </div>
                        {/* SB Code - End */}
                    </section>
                );
                ...
                return (
                    <section>
                        <div id="dialog-container" className="position-relative" style={{ minHeight: "580px" }}>
                            <DialogComponent id={styles["dialog"]} ref={dialog} className="rounded-2" target="#dialog-container" isModal={true} width="400px" beforeOpen={(event) => (event.maxHeight = '100%')} open={(event) => (event.preventFocus = true)}>
                                <div className="d-flex flex-column px-3 py-4 px-sm-4 h-100">
                                    ...
                                    <div className="d-flex flex-column gap-1 flex-grow-1 mb-4">
                                        <label className="fw-medium">Others <span className="text-body-tertiary">(Optional)</span></label>
                                        <TextAreaComponent placeholder="Please share your additional feedback to improvise" resizeMode="None" rows={6} style={{ height: "140px" }}></TextAreaComponent>
                                    </div>
                                    <div className="d-flex gap-3">
                                        <ButtonComponent cssClass="w-50" type="button">Cancel</ButtonComponent>
                                        <ButtonComponent cssClass="e-primary w-50" type="submit">Submit</ButtonComponent>
                                    </div>
                                </div>
                            </DialogComponent>
                        </div>
                        ...
                        <div className="position-absolute top-0 start-0 d-flex w-100">
                            <ButtonComponent className="e-outline mx-auto my-3" onClick={() => dialog.current?.show()} type="button">Feedback for Improvement</ButtonComponent>
                        </div>
                        {/* SB Code - End */}
                    </section>
                );
