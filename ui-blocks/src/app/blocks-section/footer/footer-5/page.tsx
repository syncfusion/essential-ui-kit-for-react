                                ...
                                <div className="grow grid grid-cols-2 gap-y-8 gap-x-1 sm:gap-x-8 sm:grid-cols-3 lg:grid-cols-5">
                                    <div>
                                        ...
                                        <ul className="mt-3 space-y-2 sm:text-nowrap">
                                            <li><a href="#" className="text-base py-1 font-medium text-primary-600 hover:underline dark:text-primary-400">About</a></li>
                                            <li><a href="#" className="text-base py-1 font-medium text-primary-600 hover:underline dark:text-primary-400">Careers</a></li>
                                            <li><a href="#" className="text-base py-1 font-medium text-primary-600 hover:underline dark:text-primary-400">Blogs</a></li>
                                        </ul>
                                    </div>
                                    <div>
                                        <h3 className="text-gray-500 dark:text-gray-400 font-semibold text-sm">Solutions</h3>
                                        <ul className="mt-3 space-y-2 sm:text-nowrap">
                                            <li><a href="#" className="text-base py-1 font-medium text-primary-600 hover:underline dark:text-primary-400">Online store builder</a></li>
                                            <li><a href="#" className="text-base py-1 font-medium text-primary-600 hover:underline dark:text-primary-400">Website builder</a></li>
                                            <li><a href="#" className="text-base py-1 font-medium text-primary-600 hover:underline dark:text-primary-400">E-commerce website</a></li>
                                        </ul>
                                    </div>
                                    <div>
                                        <h3 className="text-gray-500 dark:text-gray-400 font-semibold text-sm">Support</h3>
                                        <ul className="mt-3 space-y-2 sm:text-nowrap">
                                            <li><a href="#" className="text-base py-1 font-medium text-primary-600 hover:underline dark:text-primary-400">Help center</a></li>
                                            <li><a href="#" className="text-base py-1 font-medium text-primary-600 hover:underline dark:text-primary-400">Hire a partner</a></li>
                                            <li><a href="#" className="text-base py-1 font-medium text-primary-600 hover:underline dark:text-primary-400">ShopNezt community</a></li>
                                        </ul>
                                    </div>
                                    <div>
                                        <h3 className="text-gray-500 dark:text-gray-400 font-semibold text-sm">Resources</h3>
                                        <ul className="mt-3 space-y-2 sm:text-nowrap">
                                            <li><a href="#" className="text-base py-1 font-medium text-primary-600 hover:underline dark:text-primary-400">What's new</a></li>
                                            <li><a href="#" className="text-base py-1 font-medium text-primary-600 hover:underline dark:text-primary-400">Resource library</a></li>
                                            <li><a href="#" className="text-base py-1 font-medium text-primary-600 hover:underline dark:text-primary-400">Events</a></li>
                                        </ul>
                                    </div>
                                    <div>
                                        <h3 className="text-gray-500 dark:text-gray-400 font-semibold text-sm">Company</h3>
                                        <ul className="mt-3 space-y-2 sm:text-nowrap">
                                            <li><a href="#" className="text-base py-1 font-medium text-primary-600 hover:underline dark:text-primary-400">ShopNezt</a></li>
                                            <li><a href="#" className="text-base py-1 font-medium text-primary-600 hover:underline dark:text-primary-400">FoodNezt</a></li>
                                            <li><a href="#" className="text-base py-1 font-medium text-primary-600 hover:underline dark:text-primary-400">TravelNezt</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className="row justify-content-lg-between flex-grow-1 g-0 gy-sm-2 gy-xl-0 row-gap-4 text-body-secondary">
                                    <div className="col-6 col-sm-4 col-lg-2 px-0">
                                        ...
                                        <ul className="d-flex flex-column gap-2 list-unstyled mb-0">
                                            <li><a href="#" className="link-underline link-underline-opacity-0 link-underline-opacity-100-hover fw-medium small">About</a></li>
                                            <li><a href="#" className="link-underline link-underline-opacity-0 link-underline-opacity-100-hover fw-medium small">Careers</a></li>
                                            <li><a href="#" className="link-underline link-underline-opacity-0 link-underline-opacity-100-hover fw-medium small">Blogs</a></li>
                                        </ul>
                                    </div>
                                    <div className="col-6 col-sm-4 col-lg-2 px-0">
                                        <p className="small fw-bold mb-2 pb-1">Solutions</p>
                                        <ul className="d-flex flex-column gap-2 list-unstyled mb-0">
                                            <li><a href="#" className="link-underline link-underline-opacity-0 link-underline-opacity-100-hover fw-medium small">Online store builder</a></li>
                                            <li><a href="#" className="link-underline link-underline-opacity-0 link-underline-opacity-100-hover fw-medium small">Website builder</a></li>
                                            <li><a href="#" className="link-underline link-underline-opacity-0 link-underline-opacity-100-hover fw-medium small">E-commerce website</a></li>
                                        </ul>
                                    </div>
                                    <div className="col-6 col-sm-4 col-lg-2 px-0">
                                        ...
                                        <ul className="d-flex flex-column gap-2 list-unstyled mb-0">
                                            ...
                                            <li><a href="#" className="link-underline link-underline-opacity-0 link-underline-opacity-100-hover fw-medium small">Hire a partner</a></li>
                                            <li><a href="#" className="link-underline link-underline-opacity-0 link-underline-opacity-100-hover fw-medium small">ShopNezt community</a></li>
                                        </ul>
                                    </div>
                                    <div className="col-6 col-sm-4 col-lg-2 px-0">
                                    ...
                                    <div className="col-6 col-sm-4 col-lg-2 px-0">
                                        ...
                                        <ul className="d-flex flex-column gap-2 list-unstyled mb-0">
                                            <li><a href="#" className="link-underline link-underline-opacity-0 link-underline-opacity-100-hover fw-medium small">ShopNezt</a></li>
                                            <li><a href="#" className="link-underline link-underline-opacity-0 link-underline-opacity-100-hover fw-medium small">FoodNezt</a></li>
                                            <li><a href="#" className="link-underline link-underline-opacity-0 link-underline-opacity-100-hover fw-medium small">TravelNezt</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
