...
export default function AIFloatingWidget1() {
    /* SB Code - Start */
                ...
                return (
                    <section className="bg-gray-50 dark:bg-gray-950">
                        <div id="target" className="w-full" style={{ height: isMobileView ? "580px" : "690px" }}>
                            ...
                            <FabComponent ref={fabRef} className="!hidden sm:!block" cssClass="e-primary e-round e-bigger" iconCss={!isToggleState ? "sf-icon-help-circle !text-2xl" : "e-icons e-close !text-2xl"} type="button" position="BottomRight" target="#target" onClick={toggleDialog}></FabComponent>
                        </div>
                    </section>
                );
            case 'bootstrap5':
                return (
                    <section className="bg-body">
                        <div id="target" className="w-100" style={{ height: isMobileView ? '580px' : '690px' }}>
                                ...
                                header={() => (
                                    <div className="py-4 bg-primary">
                                        ...
                                        <div className="d-flex flex-column align-items-center">
                                            ...
                                            <p className="pt-2 pb-3 text-center text-wrap mb-0 w-50 text-white small fw-medium">Ask any question and our AI will answer</p>
                            ...
                            <FabComponent ref={fabRef} className="d-none d-sm-block" cssClass="e-primary e-round e-bigger" iconCss={!isToggleState ? 'sf-icon-help-circle fs-5 lh-base' : 'e-icons e-close fs-5 lh-base'} type="button" position="BottomRight" target="#target" onClick={toggleDialog}></FabComponent>
                        </div>
                    </section>
                );
        }
