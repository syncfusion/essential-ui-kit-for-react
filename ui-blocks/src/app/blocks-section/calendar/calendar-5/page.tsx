            ...
            case 'tailwind':
                return (
                    <section className="bg-white dark:bg-gray-900">
                        <div id={styles["calendar-todo-list"]} style={{ height: "842px", width: width, float: "right" }}>
                            <SidebarComponent ref={sidebar} className="w-full h-full flex flex-col bg-white dark:bg-gray-900" position="Right" type="Push" width={width} isOpen={true} showBackdrop={true} style={{ display: "block" }}>
                                <div className="flex-none border-b border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-900">
                                    <div className="flex justify-between items-center px-4 py-3 border-b border-gray-200 dark:border-gray-600">
                                        ...
                                        <ButtonComponent className="e-flat text-base" iconCss="e-icons e-close" type="button" onClick={() => sidebar.current?.toggle()}></ButtonComponent>
                                    </div>
                                    <div className="p-4 flex justify-center">
                                        <CalendarComponent className="e-bigger shadow-none border-none"></CalendarComponent>
                                    </div>
                                </div>
                                <div className="flex-grow overflow-y-auto bg-white dark:bg-gray-900" style={{ height: '430px' }}>
                                ...
                                <div className="flex justify-center sm:justify-start px-3 py-2 border-t border-gray-200 dark:border-gray-600 bg-gray-50 dark:bg-gray-800">
            ...
            case 'bootstrap5':
                return (
                    <section className="bg-body">
                        <div id={styles["calendar-todo-list"]} style={{ height: "832px", width: width, float: "right" }}>
                            <SidebarComponent className="d-flex flex-column bg-body" ref={sidebar} position="Right" type="Push" width={width} isOpen={true} showBackdrop={true} style={{ display: 'block' }}>
                                <div className="bg-body">
                                    ...
                                    <div className="flex-grow-1 overflow-auto" style={{ height: '430px' }}>
                                    ...
                                    <div className="d-flex justify-content-center justify-content-sm-start flex-shrink-0 px-3 py-2 border-top border-light-subtle bg-body-tertiary">
