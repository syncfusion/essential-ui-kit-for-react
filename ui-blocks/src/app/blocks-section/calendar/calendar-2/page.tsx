...
export default function Calendar2() {
    ...
    const [sliderWidth, setSliderWidth] = useState("260px");
                ...
                return (
                    <section className="bg-white dark:bg-gray-900">
                        <div style={{ height: "945px", width: width, float: "right" }}>
                            <SidebarComponent ref={sidebar} className="w-full bg-white dark:bg-gray-900" position="Right" type="Push" width={width} isOpen={true} showBackdrop={true} style={{ display: 'block' }}>
                                <div className="bg-white dark:bg-gray-900">
                                    <div className="border-b border-gray-200 dark:border-gray-600">
                                        <div className="flex justify-between items-center px-4 py-3 border-b border-gray-200 dark:border-gray-600">
                                            ...
                                            <ButtonComponent className="e-flat text-base" iconCss="e-icons e-close" onClick={() => sidebar.current?.toggle()} type="button"></ButtonComponent>
                                        </div>
                                    ...
                                    <div className="pt-4 px-1">
                                        <AccordionComponent ref={accordion1} className="border-0 bg-transparent" expandMode="Multiple">
                                        ...
                                        <div className="sliderwrap px-3 my-6">
                                            ...
                                            <div className="px-2">
                                                <SliderComponent ref={slider} type="Range" value={[2500, 4000]} tooltip={tooltipInfo} min={1000} max={5000} step={1} ticks={{ placement: 'After', largeStep: 4000, format: 'c0' }} style={{ width: sliderWidth }}></SliderComponent>
                                            </div>
                                        </div>
                                                ...
                                                <AccordionItemDirective expanded={true}
                                                    ...
                                                    content={() =>
                                                        <div className="grid gap-3 text-gray-500 p-1">
                                                            ...
                                                            <div>
                                                                <ButtonComponent cssClass="e-primary e-flat" iconCss="e-icons e-plus" content="Show more" type="button"></ButtonComponent>
                                                            </div>
                                                        </div>
                                                    }
                                                ></AccordionItemDirective>
                ...
                return (
                    <section className="bg-body">
                        <div style={{ height: "1010px", width: width, float: "right" }}>
                            <SidebarComponent ref={sidebar} className="bg-body" position="Right" type="Push" width={width} isOpen={true} showBackdrop={true} style={{ display: "block" }}>
                                <div className="bg-body">
                                    <div className="border-bottom border-light-subtle">
                                        <div className="d-flex justify-content-between align-items-center px-4 py-3 border-bottom border-light-subtle">
                                            ...
                                            <ButtonComponent className="e-flat fs-6" iconCss="e-icons e-close" onClick={() => sidebar.current?.toggle()} type="button"></ButtonComponent>
                                        </div>
                                    ...
                                    <div className="pt-2 px-1">
                                        ...
                                        <div className="sliderwrap px-3 my-4">
                                            ...
                                            <div className="px-2 w-4/5 flex justify-center w-full">
                                                <SliderComponent ref={slider} type="Range" value={[2500, 4000]} tooltip={tooltipInfo} min={1000} max={5000} step={1} ticks={{ placement: "After", largeStep: 4000, format: "C0" }} style={{ width: sliderWidth }}></SliderComponent>
                                            </div>
                                        </div>
                                        <AccordionComponent ref={accordion2} className="border-0 bg-transparent" expandMode="Multiple">
                                            <AccordionItemsDirective>
                                                <AccordionItemDirective expanded={true}
