...
export default function AIFloatingMenu3() {
    /* SB Code - Start */
    ...
    const handleMessageEvent = (event: MessageEvent) => {
        if (event.origin === window.location.origin) {
            try {
                ...
                if (blockData.name === 'ai-floating-menu-3' && blockData.theme) {
                ...
                return (
                    <section className="bg-white dark:bg-gray-800 pr-6">
                        <div id="dialog-container" style={{ minHeight: '900px' }}>
                            <DialogComponent key={"floating-3-tw"} id={styles["setting-panel"]} ref={dialogRef} className="sm:rounded-lg rounded-none overflow-hidden border-0" target="#dialog-container" visible={true} width="380px" height="880px" open={(e) => (e.preventFocus = true)} beforeOpen={(e) => (e.maxHeight = '100%')}
                                header={() => (
                                        ...
                                        <div className="flex items-center gap-2">
                                            <span className="e-avatar bg-gray-100 dark:bg-gray-700">
                                                <span className="e-avatar e-avatar-small bg-white dark:bg-gray-800">
                                                    <i className="e-icons e-chart text-lg text-orange-700 dark:text-orange-500"></i>
                                                </span>
                                            </span>
                ...
                return (
                    <section className="bg-body pe-3">
                        <div id="dialog-container" style={{ minHeight: '940px' }}>
                            <DialogComponent key={"floating-3-bs"} id={styles["setting-panel"]} ref={dialogRef} className="rounded-3" target="#dialog-container" visible={true} position={{ X: 'right', Y: '12' }} width="380px" height="920px" open={(e) => (e.preventFocus = true)} beforeOpen={(e) => (e.maxHeight = '100%')}
                                header={() => (
                                        ...
                                        <div className="d-flex align-items-center gap-2">
                                            <span className="e-avatar rounded-1 bg-body-tertiary">
                                                <span className="e-avatar e-avatar-small rounded-1 bg-body">
                                                    <i className="e-icons e-chart fs-5 text-warning"></i>
                                                </span>
                                            </span>
