            ...
            case 'tailwind':
                return (
                    <section className="bg-gray-50 dark:bg-gray-800">
                        <div id={styles["rating"]} className="pt-4" style={{ minHeight: "36rem" }}>
                                ...
                                <div className="d-flex justify-content-between align-items-center">
                                    <div className="d-flex align-items-center gap-2">
                                        <div className="position-relative" style={{ width: "48px", height: "48px" }}>
                                            ...
                                            <span className="position-absolute bottom-0 end-0 border border-2 border-light-subtle bg-success text-white rounded-circle d-flex align-items-center justify-content-center" style={{ width: '16px', height: '16px', fontSize: '10px' }}>
                                                <span className="e-icons e-check"></span>
                                            </span>
                                        </div>
